...
public class SextantInputHandler : MonoBehaviour
{
    ...
    void Update()
    {
        if (isDragging)
        {
            ...
            // Calculate and store drag length
    ...
    void StartDrag()
    {
        ...
        {
            case 1: HandleSextant1DragStart(); break;
            case 2: HandleSextant2DragStart(); break;
            case 3: HandleSextant3DragStart(); break;
            case 4: HandleSextant4DragStart(); break;
            case 5: HandleSextant5DragStart(); break;
            case 6: HandleSextant6DragStart(); break;
        }
    }
